    ...
    $.fn.formValidator = function(options) {
        ...
        var formValidator = {
            ...
            validateElement: function() {
                var $el = $(this);
                var fv = $el.data('newvision_form_validator');
            ...
            validateForm: function(e) {
                ...
                $(this.$form.prop('elements')).each(function() {
                    if (!$(this).data('newvision_form_validator')) {
                        $(this).data('newvision_form_validator', fv);
                    }
                });
        ...
        $($form.prop('elements')).each(function() {
            $(this).data('newvision_form_validator', formValidator);
        });

        $form.data('newvision_form_validator', formValidator);
