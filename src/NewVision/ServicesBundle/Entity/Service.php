 ...
 */
class Service implements PublishWorkflowInterface, SeoAwareInterface
{
    use SeoAwareTrait;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="NewVision\ServicesBundle\Entity\ServiceCategory", inversedBy="services")
    ...
    /**
     * @ORM\OneToMany(targetEntity="NewVision\ServicesBundle\Entity\ServiceTranslation", mappedBy="object", cascade={"persist", "remove"}, indexBy="locale")
     */
    ...
    /**
     * Get the value of ServiceCategories
     *
     * @return mixed
     */
    ...
    /**
     * Set the value of ServiceCategories
     *
     * @param mixed serviceCategories
     *
     * @return self
     */
