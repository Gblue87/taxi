...
/**
 *  Entity holding ServiceCategory's translations
 *
 * @ORM\Entity
 * @ORM\Table(name="service_categories_i18n", uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx", columns={
 *     "locale", "object_id"
 ...
 */
class ServiceCategoryTranslation extends AbstractTranslation
{
    /**
     * @ORM\ManyToOne(targetEntity="NewVision\ServicesBundle\Entity\ServiceCategory", inversedBy="translations")
