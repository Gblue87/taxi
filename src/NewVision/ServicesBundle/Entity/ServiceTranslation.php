...
/**
 *  Entity holding Service's translations
 *
 * @ORM\Entity
 * @ORM\Table(name="services_i18n", uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx", columns={
 *     "locale", "object_id"
...
{
    /**
     * @ORM\ManyToOne(targetEntity="NewVision\ServicesBundle\Entity\Service", inversedBy="translations")
