...
class ServiceCategoryAdmin extends Admin
{
    ...
    public function configureFormFields(FormMapper $formMapper)
    {
        ...
        $translationAdmin = $this->configurationPool->getAdminByAdminCode('newvision.services.admin.service_category_translations');
        ...
        $formMapper
            ->with('tab.general', array('tab' => true))
                ->add('parent', null, array('required' => false, 'label' => 'form.parent',
                    'class' => 'NewVision\ServicesBundle\Entity\ServiceCategory',
