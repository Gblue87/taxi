...
/**
 *  Entity holding AirportCategory's translations
 *
 * @ORM\Entity
 * @ORM\Table(name="airport_categories_i18n", uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx", columns={
 *     "locale", "object_id"
 ...
 */
class AirportCategoryTranslation extends AbstractTranslation
{
    /**
     * @ORM\ManyToOne(targetEntity="NewVision\AirportsBundle\Entity\AirportCategory", inversedBy="translations")
