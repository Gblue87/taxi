...
class AirportsAdmin extends Admin
{
    ...
    protected function configureListFields(ListMapper $list)
    {
        $list
            ...
            ->add('airportCategories', null, array('label' => 'form.categories'))
    ...
    public function configureFormFields(FormMapper $formMapper)
    {
        ...
        $translationAdmin = $this->configurationPool->getAdminByAdminCode('newvision.airports.admin.airports_translations');
        ...
        $formMapper
            ->with('tab.general', array('tab' => true))
                // ->add('airportCategories', 'sonata_type_model', array(
                //     'expanded' => false,
                //     'multiple' => true,
                //     'btn_add' => false,
