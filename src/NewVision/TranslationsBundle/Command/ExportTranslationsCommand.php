...
class ExportTranslationsCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('newvision:translations:export');
    ...
    protected function getFilesToExport()
    {
        ...
        return $this->getContainer()
            ->get('newvision_translations.translation_storage')
    ...
    protected function mergeExistingTranslations($file, $outputFile, $translations)
    {
        if (file_exists($outputFile)) {
            $loader = $this->getContainer()->get('newvision_translations.translator')->getLoader($file->getExtention());
    ...
    protected function doExport($outputFile, $translations, $format)
    {
        ...
        try {
            $exporter = $this->getContainer()->get('newvision_translations.exporter_collector')->getByFormat($format);
