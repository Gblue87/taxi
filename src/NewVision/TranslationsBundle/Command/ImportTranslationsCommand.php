...
namespace NewVision\TranslationsBundle\Command;
 ...
 * Only imports files for locales defined in newvision_translations.managed_locales.
 *
...
class ImportTranslationsCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('newvision:translations:import');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (empty($locales)) {
            $locales = $this->getContainer()->getParameter('newvision_translations.managed_locales');
        }
    ...
    protected function importComponentTranslationFiles(array $locales)
    {
        ...
        $formats = $this->getContainer()->get('newvision_translations.translator')->getFormats();
    ...
    protected function importTranslationFiles($finder)
    {
        if ($finder instanceof Finder) {
            $importer = $this->getContainer()->get('newvision_translations.importer.file');
