...
use NewVision\TranslationsBundle\Entity\File as ModelFile;
...
class TransUnitRepository extends EntityRepository
{
    ...
    protected function loadCustomHydrator()
    {
        ...
        $config->addCustomHydrationMode('SingleColumnArrayHydrator', 'NewVision\TranslationsBundle\Util\Doctrine\SingleColumnArrayHydrator');
    }
}
