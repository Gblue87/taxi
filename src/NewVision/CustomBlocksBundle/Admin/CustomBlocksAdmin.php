<?php
/**
 * This file is part of the NewVisionCustomBlocksBundle.
 *
 ...
 */
namespace NewVision\CustomBlocksBundle\Admin;
 ...
 *
 * @package NewVisionCustomBlocksBundle
        ...
        $formMapper
            ->with('tab.general', array(
                ...
                ->with('form.general', array(
                        'class' => 'col-md-12',
                        'label' => 'form.general',
                        'translation_domain' => 'NewVisionCustomBlocksBundle',
                    )
                )
            ...
            ->with('Publish Workflow', array('tab' => true))
                ->with('Publish Workflow', array('class' => 'col-md-12', 'label' => 'form.general', 'translation_domain' => 'NewVisionCustomBlocksBundle'))
